...
Weights_1 = struct('payload', 0, 'crew', 100, 'reserve_fraction', 1.05);
...
Weights_2 = struct('payload', 0, 'crew', 100, 'reserve_fraction', 1.05);
...
Weights_3 = struct('payload', 0, 'crew', 100, 'reserve_fraction', 1.05);
...
Profile_4 = {...
    ...
    struct('seg', 'CRUISE', ...
        ...
        'C', 1), ...
    struct('seg', 'CLIMB', ...
        'RoC', 900000, ... %There is no range credit for this climb
        'LD', 13, ...
        'C', 0.8), ...
    struct('seg', 'CRUISE', ...
        'range', 1580800, ...
...
Weights_4 = struct('payload', 0, 'crew', 100, 'reserve_fraction', 1.05);
...
Weights_5 = struct('payload', 0, 'crew', 100, 'reserve_fraction', 1.05);
...
Weights_6 = struct('payload', 0, 'crew', 100, 'reserve_fraction', 1.05);
...
%% Plot profile lines
hold on
ezplot(Weights_1.empty, [xlim,ylim]);
ezplot(Weights_2.empty, [xlim,ylim]);
ezplot(Weights_3.empty, [xlim,ylim]);
ezplot(Weights_4.empty, [xlim,ylim]);
ezplot(Weights_5.empty, [xlim,ylim]);
ezplot(Weights_6.empty, [xlim,ylim]);

%{
%% %Commented out as not working as expected on 2015a
